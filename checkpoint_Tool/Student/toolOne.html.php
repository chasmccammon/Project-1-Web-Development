            ...
            <form action="checkpointController.php" method="post" class="form">
                ...
                <table >
                    <tr>
                        ...
                        <td class="xAxisNeg">
                            <?php foreach ($tool1Labels as $key) {?>
                        ...
                        <td>
                            ...
                            <table class="table" >
                                ...
                                <caption class="yAxisPos" style="caption-side:top">
                                <?=  $key['northLabel']; ?>
                                </caption>

                                <!--Caption for bottom of grid -->
                                <caption class="yAxisNeg" style="caption-side:bottom">
                                    <?= $key['southLabel'];  ?>
                                    </caption>
                ...
                <p><input type="submit" class="button" name="skip1" value="Skip Question" />

                <input type="submit" class="button" name="sendAnswer1" value="Send Answer" id="sendAnswer1" /></p>
