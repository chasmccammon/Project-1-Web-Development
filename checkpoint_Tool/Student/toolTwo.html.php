            ...
            <div class="toolContent">
                ...
                <form action="checkpointController.php" method="post" class="form">
                    ...
                    <tr>
                        ...
                        <td class="xAxisNeg">
                        <?php foreach ($tool2Labels as $key) {?>
                    ...
                    <p><input type="submit" class="button" name="skip2" value="Skip Question" />

                    <input type="submit" class="button" name="sendAnswer2" value="Send Answer" id="sendAnswer2"/></p>
