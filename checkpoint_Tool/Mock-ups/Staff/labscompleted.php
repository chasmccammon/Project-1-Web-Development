        ...
        if($RowCount>0)
          {
            try
            {
                ...
                $table = "SELECT Students.userName,COUNT(Data.labID) as 'labcount', ";
                for ($i=1; $i <=  $numrows; $i++) { 
             ...
             $table.= " FROM Data INNER JOIN Students on Students.studentid = Data.studentid GROUP BY Data.studentid ORDER BY Students.lastName";
