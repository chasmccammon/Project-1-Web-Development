<!--Designed By: Olufemi Olusina & Albert Warner
    ...
    Description:
    This page is used to display the form that the user can use to enter lab numbers to mark off.
...
<body>
        ...
        <!--************************CONTENT****************************-->
            ...
            <div class="content">
            <h2>CHECKPOINT:</h2>
            <form action="checkpointController.php" method="post" class="input">
                ...
                <input type="hidden" name="labID" value="<?=  $labNumber ?>"/>
                    ...
                    <label>Tutor Password: </label>
                        <input type="text" pattern="[0-9]{1,}" autocomplete="off" name="tutorPassword" id="tutorPassword" class="entry password" required/>

                    <p><input type="submit" class="button" name="checkpointComplete" value="Mark Checkpoint Complete" /></p>
                </form>
