...
<?php 
    ...
    *****************************************/
    ...
    if(isset($_POST['checkpointComplete'])) {
        ...
        ###########################################
        $multiplier = $labNumber * 5; //Takes the lab number selected multiplied by 2 and concatenated to create password.
        $passCode = 100;
                ...
                if ($result->total > 0) 
                {
                    ...
                    if ($result->total > 0) 
                    {
                        try{
                            ...
                            $insertQuery ="INSERT into Data(studentID,labID,responseTime)                
