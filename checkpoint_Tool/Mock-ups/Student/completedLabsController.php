    ...
    /***********CHECK FOR USER INPUT************/
        ...
        if ($result->total <= 0) 
        {
            ...
            include "noResult.html.php";
                ...
                $table.= " FROM Data INNER JOIN Students on Students.studentID = Data.labID WHERE Students.studentID = \"$id\"  GROUP BY Data.studentid";
                ...
                $table.= " FROM Data INNER JOIN Students on Students.studentID = Data.studentID WHERE Students.studentID = \"$id\"  GROUP BY Data.studentID";
                $stmt = $pdo->query($table);
